...
with open("../vocab-5.txt", 'w', encoding='utf-8') as f:
    for key, value in vocab.items():
        if value > min_freq:
            f.writelines(key + '\n')
with open("../StackOverflow-all-stemmed.txt", 'w', encoding='utf-8') as f:
    for i in range(dataset_number):
        ...
        for j in text[index[i]].split():
            if vocab[j] > min_freq:
                t.append(j)
        f.writelines(" ".join(t) + '\n')
with open("../StackOverflow-train-stemmed.txt", 'w', encoding='utf-8') as f:
    for i in range(real_train_size):
        ...
        for j in text[index[i]].split():
            if vocab[j] > min_freq:
                t.append(j)
        f.writelines(" ".join(t) + '\n')
with open("../StackOverflow-dev-stemmed.txt", 'w', encoding='utf-8') as f:
    for i in range(real_train_size, real_train_size+dev_size):
        ...
        for j in text[index[i]].split():
            if vocab[j] > min_freq:
                t.append(j)
        f.writelines(" ".join(t) + '\n')
with open("../StackOverflow-test-stemmed.txt", 'w', encoding='utf-8') as f:
